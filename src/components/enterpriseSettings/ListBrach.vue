   ...
   <div class="py-3 px-2 sm:px-4 bg-white rounded-lg flex text-black items-start gap-2 sm:gap-3">
      ...
      <div class="flex flex-col gap-2 w-full min-w-0">
         ...
         <div class="w-full overflow-x-auto">
            <table class="min-w-[760px] md:min-w-full border-none bg-white rounded-lg z-10">
               <thead
                  class="bg-slate-200 h-7 text-sm font-semibold sticky top-0 text-customDarkBlue flex-shrink-0 z-10"
               >
                  <tr class="h-7">
                     <th class="w-6 text-left font-semibold text-slate-800 whitespace-nowrap px-2">#</th>
                     <th class="text-left font-semibold text-slate-800 whitespace-nowrap px-2">
                        {{ $t('v1.table.short_name') }}
                     </th>
                     <th class="text-left font-semibold text-slate-800 whitespace-nowrap px-2">
                        {{ $t('v1.table.address') }}
                     </th>
               ...
               <tbody>
                  ...
                  >
                     <!-- stt-->
                     <td class="px-2 py-2 text-left items-center space-x-4">
                        <p>{{ index + 1 }}</p>
                     </td>
                     <!-- tên viết tắt -->
                     <td class="px-2 text-left py-2 items-center space-x-4">
                     ...
                     <!-- ngày thành lập -->
                     <td class="px-2 text-left py-2 text-customGray text-15px">
         ...
         <main class="flex flex-col p-6 border-b border-t gap-2.5 border-gray-200">
            <div class="flex gap-2.5 sm:flex-row flex-col">
               ...
               <div class="flex-1 text-left h-16 relative space-y-1">
                  ...
                  />
                  <IconArrow class="w-4 h-4 text-slate-600 absolute right-10 sm:right-2 top-1/2"></IconArrow>
               </div>
            </div>
            <!--  -->
